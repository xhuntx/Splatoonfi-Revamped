...
const songsData = [
  { id: 1, title: "", artist: "", cover: "", audio: "" },
  { id: 2, title: "", artist: "", cover: "", audio: "" },
  { id: 3, title: "", artist: "", cover: "", audio: "" },
  { id: 4, title: "", artist: "", cover: "", audio: "" },
  { id: 5, title: "", artist: "", cover: "", audio: "" },
  { id: 6, title: "", artist: "", cover: "", audio: "" },
  { id: 7, title: "", artist: "", cover: "", audio: "" },
  { id: 8, title: "", artist: "", cover: "", audio: "" },
  { id: 9, title: "", artist: "", cover: "", audio: "" },
];
          ...
          <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-900 text-white">
            ...
            <section className="min-h-screen flex flex-col items-center justify-start gap-8 px-6 py-24 w-full">
              <div className="text-center max-w-4xl mx-auto">
                <ScrollReveal>
                  <h1 className="text-4xl font-bold mb-6">Splatoon 2 Music</h1>
                </ScrollReveal>
              </div>
